...
public class MySqlProductDao implements ProductDao
{
    ...
    {
        var sql = """
                INSERT INTO products (product_name, category_id, quantity_per_unit, unit_price, supplier_id)
                VALUES (?, ?, ?, ?, ?);
                """;
    ...
    private Product mapRowToProduct(SqlRowSet row)
    {
        ...
        Integer supplierId = (Integer)row.getObject("supplier_id");

        return new Product(id, name,categoryId, quantityPerUnit, unitPrice, supplierId);
    }
}
