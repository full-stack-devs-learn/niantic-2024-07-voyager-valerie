...
CREATE TABLE `order_details` (
    ...
    `discount` REAL(10,2) NOT NULL DEFAULT 0,
...
CREATE TABLE `Products` (
    ...
    `units_in_stock` SMALLINT(2) DEFAULT 0,
    `units_on_order` SMALLINT(2) DEFAULT 0,
    `reorder_level` SMALLINT(2) DEFAULT 0,
...
VALUES (null,'Beverages','Soft drinks, coffees, teas, beers, and ales')
...
VALUES (null,'Davolio','Nancy','Sales Representative','Ms.', '1948-12-08','1992-05-01','507 - 20th Ave. E.Apt. 2A','Seattle','WA','98122','USA','(206) 555-9857','5467','Education includes a BA in psychology from Colorado State University in 1970.  She also completed "The Art of the Cold Call."  Nancy is a member of Toastmasters International.',2,'2954.55')
    ...
    , (null,'Buchanan','Steven','Sales Manager','Mr.','1955-03-04','1993-10-17','14 Garrett Hill','London',NULL,'SW1 8JR','UK','(71) 555-4848','3453','Steven Buchanan graduated from St. Andrews University, Scotland, with a BSC degree in 1976.  Upon joining the company as a sales representative in 1992, he spent 6 months in an orientation program at the Seattle office and then returned to his permanent post in London.  He was promoted to sales manager in March 1993.  Mr. Buchanan has completed the courses "Successful Telemarketing" and "International Sales Management."  He is fluent in French.',2,'1744.21')
    , (null,'Suyama','Michael','Sales Representative','Mr.','1963-07-02','1993-10-17','Coventry House Miner Rd.','London',NULL,'EC2 7JR','UK','(71) 555-7773','428','Michael is a graduate of Sussex University (MA, economics, 1983) and the University of California at Los Angeles (MBA, marketing, 1986).  He has also taken the courses "Multi-Cultural Selling" and "Time Management for the Sales Professional."  He is fluent in Japanese and can read and write French, Portuguese, and Spanish.',5,'2004.07')
    , (null,'King','Robert','Sales Representative','Mr.','1960-05-29','1994-01-02','Edgeham Hollow Winchester Way','London',NULL,'RG1 9SP','UK','(71) 555-5598','465','Robert King served in the Peace Corps and traveled extensively before completing his degree in English at the University of Michigan in 1992, the year he joined the company.  After completing a course entitled "Selling in Europe," he was transferred to the London office in March 1993.',5,'1991.55')
    , (null,'Callahan','Laura','Inside Sales Coordinator','Ms.','1958-01-09','1994-03-05','4726 - 11th Ave. N.E.','Seattle','WA','98105','USA','(206) 555-1189','2344','Laura received a BA in psychology from the University of Washington.  She has also completed a course in business French.  She reads and writes French.',2,'2100.50')
    , (null,'Dodsworth','Anne','Sales Representative','Ms.','1966-01-27','1994-11-15','7 Houndstooth Rd.','London',NULL,'WG2 7LT','UK','(71) 555-4444','452','Anne has a BA degree in English from St. Lawrence College.  She is fluent in French and German.',5,'2333.33');
...
INSERT INTO order_details (order_id, product_id, unit_price, quantity, discount) Values (10248, 11, 14, 12, 0.0);
...
# ---------------------------------------------------------------------- #
# Add Procedure "customer_order_history"                                          #
# ---------------------------------------------------------------------- #
...
CREATE PROCEDURE `customer_order_history`(in customer_id varchar(5))
BEGIN
...
# ---------------------------------------------------------------------- #
# Add Procedure "customer_order_search"                                       #
# ---------------------------------------------------------------------- #

DROP PROCEDURE IF EXISTS `customer_order_search`;

DELIMITER $$

CREATE PROCEDURE `customer_order_search`(in customer_id varchar(5))
BEGIN
...
# ---------------------------------------------------------------------- #
# Add Procedure "sales_by_category"                                        #
# ---------------------------------------------------------------------- #

DROP PROCEDURE IF EXISTS `sales_by_category`;
DELIMITER $$

CREATE DEFINER=`root`@`localhost` PROCEDURE sales_by_category(
    IN category_name NVARCHAR(15),
    IN order_year NVARCHAR(4)
)
BEGIN
    IF order_year != '2011' AND order_year != '2012' AND order_year != '2013' THEN
        SET order_year = '2013';
    END IF;

    SELECT product_name
        , ROUND(SUM(OD.Quantity * (1 - OD.Discount) * OD.UnitPrice), 0) AS total_purchase
    ...
    WHERE C.CategoryName = `CategoryName`
        AND SUBSTRING(CONVERT(O.OrderDate, CHAR), 1, 4) = order_year
    GROUP BY product_name
...
# ---------------------------------------------------------------------- #
# UPDATE Dates to be more relevant                                       #
# ---------------------------------------------------------------------- #

UPDATE employees
SET birth_date = date_add(birth_date, INTERVAL 30 YEAR)
	, hire_date = date_add(hire_date, INTERVAL 20 YEAR)
WHERE employee_id > 0;

UPDATE orders
SET order_date = date_add(order_date, INTERVAL 25 YEAR)
	, required_date = date_add(required_date, INTERVAL 25 YEAR)
	, shipped_date = date_add(shipped_date, INTERVAL 25 YEAR)
WHERE order_id > 0;
